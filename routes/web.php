...
Route::middleware('auth')->group(function () {
    ...
    Route::get('EliminarVersion/{id}/version/{version_id}', [PreguntaController::class, 'Eliminarversion'])->name('pregunta.version');
    ...
    Route::get('grupoAlumnos', [GrupoController::class, 'alumnos'])->name('grupoAlumnos');
    ...
    Route::post('evaluacion-cargar-archivo', [FormatoEvaluacionController::class, 'cargarArchivo'])->name('evaluacion.cargarArchivo');
    ...
    Route::get('report/vista', [Reporte::class, 'vista'])->name('vista');
    Route::get('report/top3', [Reporte::class, 'top3'])->name('top3');
    Route::get('report/datostop3', [Reporte::class, 'datostop3'])->name('datostop3');
    Route::get('report/historial/{id}', [Reporte::class, 'historial'])->name('historial');
    Route::get('report/estado/{id}', [Reporte::class, 'estado'])->name('estado');
    Route::get('report/cuestionarios', [Reporte::class, 'cuestionarios'])->name('cuestionarios');
    Route::get('report/datoscuestionarios', [Reporte::class, 'datoscuestionarios'])->name('datoscuestionarios');
    Route::get('report/recursamiento', [Reporte::class, 'recursamiento'])->name('recursamiento');
    Route::get('report/datosrecursamiento', [Reporte::class, 'datosrecursamiento'])->name('datosrecursamiento');
    Route::get('report/evaluacion', [Reporte::class, 'evaluacion'])->name('evaluacion');
    Route::get('report/datosevaluacion', [Reporte::class, 'datosevaluacion'])->name('datosevaluacion');
