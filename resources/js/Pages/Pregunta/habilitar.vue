...
<div>
    ...
    <div>
      ...
      <a :href="generateRoute('Análisis académico')" class="action-button" >
        Enviar 
      </a>
    </div>
<br>
    ...
    <div>
      ...
      <a :href="generateRoute('Habitos de estudio')" class="action-button">
       Enviar
      </a>
    </div>
    <br>
    ...
    <div>
      ...
      <a :href="generateRoute('Inteligencias múltiples')" class="action-button">
       Enviar
      </a>
    </div>
  </div>
