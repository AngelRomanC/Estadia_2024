        ...
        <CardBox v-else class="mb-6" has-table>
            <form @submit.prevent="buscarPreguntas" class="flex justify-between">
                ...
                <div  class="ml-auto">
                    ...
                    <BaseButton :href="route('pregunta.agregar-pregunta', { id: 1, version_id: form.version })" class="action-button" label="Agregar nueva pregunta" />
            ...
            <div v-if="form.version !== null" class="before:hidden lg:w-1 whitespace-nowrap">
                <BaseButton :href="route('pregunta.version', { id: 1, version_id: form.version })" 
                color="danger" label="Eliminar versión" />
            </div>
