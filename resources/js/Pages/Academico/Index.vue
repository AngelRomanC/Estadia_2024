...
export default {
    props: {
        ...
        acumuladas:{ type: Object, required: true },
    ...
    <LayoutMain>
        ...
        <CardBox v-for="academico in Academico" :key="academico.id">
            ...
            <div>
                ...
                <div v-if="acumuladas">
                    <strong>Materias reprobadas acumuladas</strong>
                </div>
                
                <div v-for="acumulada in acumuladas" :key="acumulada.id">   
                    {{ acumulada.materia }}
                </div>

                <div>
                    <!--<strong>Numero de materias reprobadas acumuladas:</strong> {{ academico.numero}} -->
                ...
                <div>
                    <BaseButton :href="`academico/${academicoId}/edit/${academico.version}`" class="action-button" label="Modificar formato" style="float: right;"/>
