...
<template>
    <LayoutMain>
        ...
        <form @submit.prevent="buscarformato">
            ...
            <button type="submit" class="action-button">Generar formato</button>
        </form>
        ...
        <CardBox v-for="inteligencia in Inteligencia" :key="inteligencia.id">
            ...
            <div>
                ...
                <BaseButton :href="`inteligencia/${inteligencia.id}/edit/${inteligencia.version}`" class="action-button" label="Modificar formato"  style="float: right;"/>
