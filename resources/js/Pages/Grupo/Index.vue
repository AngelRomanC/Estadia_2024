...
<template>
    <LayoutMain>
        <SectionTitleLineWithButton  :title="titulo" main>
            <BaseButton :href="'grupo/create'" class="action-button" label="Agregar grupo" />
        </SectionTitleLineWithButton>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-2">
        <div v-for="item in grupos.data" :key="item.id"
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <span v-for="alumno in item.alumnos" :key="alumno.id">
                        ...
                        <span class="ml-3">
                            <BaseButton class="iconred" :icon="mdiTrashCan" small @click="eliminarAlumno(item.id, alumno.id)" />
                        </span>
                    </span >
            ...
            <div class="flex justify-end items-end p-4">
                ...
                <BaseButtons>
                    <BaseButton  :icon="mdiApplicationEdit" small
                                :href="route(`${routeName}edit`, item.id)" class='ml-2 icon'/>
