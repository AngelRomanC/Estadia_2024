...
export default {
    ...
    setup(props) {
        ...
        const thereAreResults = computed(() => props.users.total > 0);
        const filtrar = () => {
                ...
                <form @submit.prevent="filtrar" class="flex flex-col md:flex-row items-center">
                    ...
                    <div class="relative md:w-full">
                        <input type="search" id="search-dropdown"
                            class="p-3 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-200 border-l border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
